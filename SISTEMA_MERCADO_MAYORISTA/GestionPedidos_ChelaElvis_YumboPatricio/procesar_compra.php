            ...
            <tbody>
                ...
                if (isset($_SESSION['carrito']) && count($_SESSION['carrito']) > 0) {
                    foreach ($_SESSION['carrito'] as $id => $item) {
                        ...
                        echo "<td>" . htmlspecialchars($item['local']) . "</td>";
                        echo "</tr>";
                    }
                } else {
        ...
        <form action="finalizar_pago.php" method="post">
            <div class="form-group">
                ...
                <div id="detalles-transferencia" class="payment-details">
                    ...
                    <p><strong>Referencia:</strong> <?php echo $referencia_pago; ?></p>
                    <p>Una vez realizada la transferencia, envíe el comprobante a: edgar.yumbo@ueb.edu.ec</p>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div id="detalles-efectivo" class="payment-details">
                    ...
                    <p><strong>Por favor acuda a pagar en:</strong> Av. Principal #123, Col. Centro</p>
                    <p><strong>Horario de atención:</strong> Lunes a Viernes de 9:00 a 18:00</p>
                    <p><strong>Referencia de pago:</strong> <?php echo $referencia_pago; ?></p>
